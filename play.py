...
intro = '''You, the only surviving doctor of your vilage, are in search of a cure for a life threatening disease, Duck Face Caseinate Influenza, which has overcome your entire village.
'''
...
while True:
    if location == "woods":
        print("You slowly walk into the darkened woods, careful not to disturb any unknown, nearby wildlife. Suddenly, you realized you startled a black mama bear, infuriating it in the process. You only have two choices: flight or flop?")
        sit_1 = input()
        if sit_1 =="flop":
            print("Don't pretend to be dead when confronted by a black bear. You just died. FAILURE", bad_end)
        if sit_1=="flight":
            print("You ran to a nearby tree and climbed up. The bear didn't seem to leave so now it's morning and you've spent the night on a tree branch.")
        ...
        print("It's getting icreasingly dark and you have to hurry back before nightfall. To run too quickly and you fall into a ditch, spraining your ankle in the process. Despite your sudden shock, you only have two options: Wait to be rescued or make a splint")
        sit_2= input()
